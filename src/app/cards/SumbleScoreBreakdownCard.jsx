...
const SumbleScoreBreakdownCard = ({ actions }) => {
  ...
  return (
    <Flex direction="column" gap="medium">
      {/* ---- Header: score, tier, segment ---- */}
      <Tile>
        <Flex direction="column" gap="small">
          <Statistics>
            <StatisticsItem label="Score" number={bd.score ?? "—"} />
            <StatisticsItem label="Tier" number={bd.tier || "—"} />
            <StatisticsItem label="Segment" number={bd.segment || "—"} />
          </Statistics>
          {ext(bd.sumble_url) ? <Link href={ext(bd.sumble_url)}>Open in Sumble</Link> : null}
        </Flex>
      </Tile>
      ...
      <Tile>
        <Flex direction="column" gap="small">
          <Heading inline>Score breakdown</Heading>
          ...
          {signals.length === 0 ? (
            ...
            <Table bordered>
              <TableHead>
                <TableRow>
                  <TableHeader width="auto">Signal</TableHeader>
